...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Temple of the Tooth'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Temple of the <span class="hero_title_orange">Tooth</span></h1>
            </div>
...
<p>So whether you're a devout Buddhist, a history enthusiast, or simply someone with a sense of curiosity, the Temple of the Tooth beckons with open arms, inviting you to explore its rich history and discover the peace and serenity that lie hidden within its ancient walls.</p>
                    </article>
