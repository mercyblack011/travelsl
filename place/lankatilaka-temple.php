...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Lankatilaka Temple'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Lankatilaka <span class="hero_title_orange">Temple</span></h1>
            </div>
...
<p>So whether you're a devout Buddhist, a history enthusiast, or simply someone with a sense of adventure, Lankatilaka Temple beckons with open arms, inviting you to explore its rich heritage and discover the secrets that lie hidden within its ancient walls.</p>
                    </article>
