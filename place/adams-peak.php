...
<head>
	<title>Adam's Peak-Travelsl</title>
	<meta charset="utf-8">
	...
	<style>
		...
		.write-btn {
			...
			letter-spacing: 2px; text-transform: uppercase;
			text-align: center; border-radius: 30px; border: none; cursor: pointer;
		...
		.rtab {
			...
			color: #999; cursor: pointer; background: #fff;
			transition: all 0.2s;
		}
		...
		.load-more-btn:hover { border-color: #FF9500; color: #FF9500; }
		...
		.load :first-child  { background: var(--orange); }
		.load :nth-child(2) { background: #ffb347; }
		.load :nth-child(3) { background: var(--purple); }
		.load :last-child   { background: var(--dark); }
	</style>
</head>
...
<!-- PRELOADER -->
	...
	<div class="home_hero">
			...
			$sql = "SELECT image_url FROM  place WHERE id = '2'"; // Change the WHERE condition as needed
		...
		<div class="hero_content">
			<div class="hero_eyebrow">+ SACRED MOUNTAIN</div>
			<h1 class="hero_title">Adam's <span class="hero_title_orange">Peak</span></h1>
		</div>
...
<section class="content-1">
	<div class="place-section-header">
		<h2>About This Place</h2>
	</div>
	<article class="art"> 
	<p>Adam's Peak, also known as Sri Pada, is a sacred mountain located in the central highlands of Sri Lanka. Rising to an elevation of 2,243 meters (7,359 feet), it is renowned for its religious significance and natural beauty. The peak is a prominent pilgrimage site, drawing devotees from various religions including Buddhists, Hindus, Christians, and Muslims.</p>

<p>One of the most distinctive features of Adam's Peak is the "Sri Pada" - a footprint-shaped mark at the summit, which is believed by Buddhists to be the footprint of Lord Buddha, by Hindus as that of Lord Shiva, and by Christians and Muslims as that of Adam (hence the name Adam's Peak).</p>

<p>The pilgrimage season to Adam's Peak typically begins in December and continues until May, coinciding with the dry season in Sri Lanka. Pilgrims undertake the ascent primarily during the night to reach the summit in time for sunrise. The climb is not only a religious journey but also a physical challenge, with thousands of steps leading to the peak.</p>

<p>From the summit, visitors are rewarded with breathtaking panoramic views of the surrounding landscapes, especially at sunrise. On clear mornings, the shadow of the peak is cast upon the clouds, a spectacular phenomenon known as the "Shadow of the Peak."</p>

<p>The area around Adam's Peak is rich in biodiversity, featuring diverse flora and fauna typical of the Sri Lankan hill country. The journey to this sacred mountain is an immersive experience, combining spirituality, nature, and adventure.</p>
	...
	<div>
	 ...
	 <p class="map"> 
	 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31693.379334459292!2d80.47874558469557!3d6.80964241219469!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae3977589234b59%3A0x8723ad471d5b37dc!2sSri%20Pada%20%2F%20Adam&#39;s%20Peak!5e0!3m2!1sen!2slk!4v1714395752057!5m2!1sen!2slk" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	 </p>
...
<div class="review-layout">
    ...
    <div>
        ...
        <?php foreach($reviews as $idx => $review):
            ...
            $badge_colors = [
                5 => 'background:rgba(255,149,0,0.1);color:#FF9500;',
                4 => 'background:rgba(123,47,190,0.1);color:#7B2FBE;',
                3 => 'background:rgba(6,182,212,0.1);color:#06b6d4;',
                2 => 'background:rgba(239,68,68,0.1);color:#ef4444;',
                1 => 'background:rgba(239,68,68,0.1);color:#ef4444;',
            ];
            $badge_style = $badge_colors[$rating] ?? $badge_colors[5];
        ?>
        <div class="review-card" data-rating="<?php echo $rating; ?>">
            <div class="card-top">
                <div class="rc-avatar" style="background:<?php echo $grad; ?>">
...
function loadMore(){
    var hidden = document.querySelectorAll('.review-card[style*="none"]');
    var count = 0;
    hidden.forEach(function(c){
        if(count < 3){ c.style.display=''; count++; }
    });
    if(document.querySelectorAll('.review-card[style*="none"]').length === 0){
