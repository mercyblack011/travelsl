...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Kanniya Hot Water Springs'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Kanniya Hot Water <span class="hero_title_orange">Springs</span></h1>
            </div>
