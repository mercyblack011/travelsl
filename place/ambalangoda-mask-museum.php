...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Ambalangoda mask museum'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Ambalangoda mask <span class="hero_title_orange">museum</span></h1>
            </div>
