...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Umandawa Global Buddhist Village'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Umandawa Global Buddhist <span class="hero_title_orange">Village</span></h1>
            </div>
