...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Negadee Ancient Temple Jaffna'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Negadee Ancient Temple <span class="hero_title_orange">Jaffna</span></h1>
            </div>
