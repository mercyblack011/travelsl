...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Sri Lanka Air Force Museum'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Sri Lanka Air Force <span class="hero_title_orange">Museum</span></h1>
            </div>
