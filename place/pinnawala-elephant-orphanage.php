...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Pinnawala Elephant Orphanage'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Pinnawala Elephant <span class="hero_title_orange">Orphanage</span></h1>
            </div>
