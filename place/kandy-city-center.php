...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Kandy City Center'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Kandy City <span class="hero_title_orange">Center</span></h1>
            </div>
...
<p>So whether you're a history enthusiast, a culture vulture, or simply someone with a sense of adventure, Kandy City Center beckons with open arms, inviting you to explore its rich heritage and discover the secrets that lie hidden within its ancient streets and storied landmarks.</p>
                    </article>
