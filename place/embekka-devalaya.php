...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Embekka Devalaya'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Embekka <span class="hero_title_orange">Devalaya</span></h1>
            </div>
...
<p>So whether you're a spiritual seeker, an art aficionado, or simply someone with an appreciation for beauty and history, Embekka Devalaya beckons with open arms, inviting you to explore its hallowed halls and uncover the secrets of Sri Lanka's rich cultural tapestry.</p>
                    </article>
