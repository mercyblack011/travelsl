...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'National Shrine Of Our Lady Madhu'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">National Shrine Of Our Lady <span class="hero_title_orange">Madhu</span></h1>
            </div>
