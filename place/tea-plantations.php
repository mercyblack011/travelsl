...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Tea Plantations'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Tea <span class="hero_title_orange">Plantations</span></h1>
            </div>
...
<p>So whether you're a nature lover, a history buff, or simply someone who enjoys a good cup of tea, Sri Lanka's tea plantations beckon with open arms, inviting you to explore their scenic beauty, rich heritage, and delicious flavors.</p>
                    </article>
