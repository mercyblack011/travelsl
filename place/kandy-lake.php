...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Kandy Lake'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Kandy <span class="hero_title_orange">Lake</span></h1>
            </div>
...
<p>So whether you're a nature lover, a history buff, or simply someone looking to escape the stresses of everyday life, Kandy Lake beckons with open arms, inviting you to immerse yourself in the beauty and tranquility of this hidden gem in the heart of Sri Lanka's hill country.</p>
                    </article>
