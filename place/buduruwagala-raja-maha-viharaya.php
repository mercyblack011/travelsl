...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Buduruwagala Raja Maha Viharaya'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Buduruwagala Raja Maha <span class="hero_title_orange">Viharaya</span></h1>
            </div>
