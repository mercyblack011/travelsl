...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Tissamaharama Raja Vagarai'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Tissamaharama Raja <span class="hero_title_orange">Vagarai</span></h1>
            </div>
