...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Thai Manor Beach'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Thai Manor <span class="hero_title_orange">Beach</span></h1>
            </div>
