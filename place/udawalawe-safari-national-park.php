...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Udawalawe Safari National Park'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Udawalawe Safari National <span class="hero_title_orange">Park</span></h1>
            </div>
