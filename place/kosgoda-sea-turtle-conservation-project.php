...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Kosgoda Sea Turtle Conservation Project'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Kosgoda Sea Turtle Conservation <span class="hero_title_orange">Project</span></h1>
            </div>
