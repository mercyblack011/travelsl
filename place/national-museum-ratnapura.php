...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'National Museum Ratnapura'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">National Museum <span class="hero_title_orange">Ratnapura</span></h1>
            </div>
