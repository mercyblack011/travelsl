...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'World Tallest Granite Buddha Statue'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">World Tallest Granite Buddha <span class="hero_title_orange">Statue</span></h1>
            </div>
