...
">
        ...
        <div class="home_hero">
            ...
            $sql = "SELECT image_url FROM place WHERE name = 'Kandy Esala Perahera'";
            ...
            <div class="hero_content">
                ...
                <h1 class="hero_title">Kandy Esala <span class="hero_title_orange">Perahera</span></h1>
            </div>
...
<p>So whether you're a devout Buddhist, a culture enthusiast, or simply someone with a sense of adventure, the Kandy Esala Perahera beckons with open arms, inviting you to immerse yourself in the magic and mystery of this ancient and venerable tradition.</p>
                    </article>
