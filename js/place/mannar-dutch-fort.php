...
<head>
	<title>Mannar Dutch Fort-Travelsl</title>
	<meta charset="utf-8">
...
<div class="preloader">
    ...
    contentElements.forEach(function(element) {
		...
		<div class="home">
			...
			$sql = "SELECT image_url FROM  place WHERE name = 'Mannar Dutch Fort'"; // Change the WHERE condition as needed
			...
			<div class="home_content">
				<div class="home_title">Mannar Dutch Fort
</div>
			</div>
		</div>
...
<section class="content-1">
    ...
    <article class="art"> 
	<p>Nestled amidst the windswept plains of Sri Lanka's northwestern coast, Mannar Dutch Fort is a testament to the island's colonial past and a reminder of the rich history and heritage that has shaped the region for centuries. Located on the island of Mannar, this historic fort is one of the oldest and most well-preserved examples of Dutch colonial architecture in Sri Lanka, making it a must-visit destination for history buffs and culture enthusiasts alike.</p>
<p>As you explore Mannar Dutch Fort, you're transported back in time to a bygone era of colonial conquest and intrigue. The fort's imposing walls and sturdy bastions stand as a testament to the Dutch East India Company's efforts to establish a foothold in the region and protect their lucrative trade routes from rival European powers.</p>
<p>But it's not just the history that makes Mannar Dutch Fort so special; it's also the sense of mystery and adventure that pervades the entire area. The fort is surrounded by a vast expanse of windswept plains and salt marshes, home to a rich variety of wildlife and bird species, as well as ancient ruins and archaeological sites waiting to be discovered.</p>
<p>For history enthusiasts and culture vultures, a visit to Mannar Dutch Fort offers the chance to step back in time and immerse yourself in the sights and sounds of colonial-era Sri Lanka. Whether you're exploring the fort's crumbling ramparts and hidden passageways, marveling at the panoramic views from its towering watchtowers, or simply soaking up the atmosphere amidst the tranquil surroundings, there's something for everyone to enjoy at this iconic landmark.</p>
<p>So whether you're a history buff, an architecture aficionado, or simply someone with a sense of adventure, Mannar Dutch Fort beckons with open arms, inviting you to explore its rich heritage and discover the secrets that lie hidden within its ancient walls.</p>        
    </article>
	...
	<div>
	 ...
	 <p class="map"> 
	 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.959697327626!2d79.91441610973091!3d8.975855891046178!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3afdd9e2e4ffffff%3A0x34b3338ceafeb5d6!2sMannar%20Dutch%20Fort!5e0!3m2!1sen!2slk!4v1714461693780!5m2!1sen!2slk" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	 </p>
