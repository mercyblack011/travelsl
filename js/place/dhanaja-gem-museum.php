...
<head>
	<title>Dhanaja Gem Museum-Travelsl</title>
	<meta charset="utf-8">
...
<div class="preloader">
    ...
    contentElements.forEach(function(element) {
		...
		<div class="home">
			...
			$sql = "SELECT image_url FROM  place WHERE name = 'Dhanaja Gem Museum'"; // Change the WHERE condition as needed
			...
			<div class="home_content">
				<div class="home_title">Dhanaja Gem Museum
				</div>
			</div>
		</div>
	...
	<div>
		<div class="container">
			...
			<section class="content-1">
				...
				<article class="art"> 
				<p>Located in the heart of Sri Lanka's gem mining region, the Dhanaja Gem Museum is a treasure trove of precious stones and rare minerals that showcases the island nation's rich geological heritage. Established by the Dhanaja Group, one of the country's leading gem dealers, the museum offers visitors a unique opportunity to learn about the art of gemstone mining and the cultural significance of these sparkling treasures.</p>
<p>As you step through the doors of the Dhanaja Gem Museum, you're greeted by a dazzling display of gems and minerals from around the world, including sapphires, rubies, emeralds, and diamonds. From raw specimens freshly unearthed from the earth to polished gemstones gleaming in the light, every exhibit tells a story of the natural forces that have shaped our planet over millions of years.</p>
<p>But the museum's collection is more than just a showcase of rare and beautiful stones; it's also a testament to the craftsmanship and skill of Sri Lanka's gemstone artisans. Through a series of interactive exhibits and demonstrations, visitors can learn about the process of gem cutting, polishing, and setting, gaining insight into the ancient traditions and modern techniques that have made Sri Lanka a world-renowned center for gemstone production.</p>
<p>For gem enthusiasts and collectors, a visit to the Dhanaja Gem Museum is a must, offering the chance to admire some of the finest examples of Sri Lanka's most coveted gemstones. Whether you're searching for the perfect engagement ring or simply looking to marvel at the natural beauty of these exquisite stones, the museum promises to be a truly sparkling experience.</p>
<p>So whether you're a gem connoisseur, a history buff, or simply someone with an appreciation for beauty and craftsmanship, the Dhanaja Gem Museum invites you to embark on a journey through the dazzling world of precious stones and rare minerals.</p>
				...
				<div>
					 ...
					 <p class="map"> 
					 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.536561853567!2d80.38377640970246!3d6.704170193263478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae3beddc0c3e82d%3A0x5d781388726130a1!2sDhanaja%20Gem%20Museum!5e0!3m2!1sen!2slk!4v1714395412584!5m2!1sen!2slk" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					 </p>
		...
		<div class="col text-center">
			...
			<h6 id="fh6">Your review will help us to improve our web hosting quality products, and customer services.
			</h6>
		</div>
		<br>
		<br>
		...
		<form id="feedback" action="" method="post">
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						...
						<?php if (!empty($ratingError))
							echo '<div style="color:red;">' . $ratingError . '</div>'; ?>
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						...
						<?php if (!empty($reviewError))
							echo '<div style="color:red;">' . $reviewError . '</div>'; ?>
					</div>
				</div>
			</div>
			<br>
			...
			<div class="form-group" style="text-align: center;">
				<button type="submit" class="btn btn-primary"
					style="display: block; margin-left: 20px; padding-top: 10px;">Submit</button>
			</div>
		</form>
		...
		<div class="review-container">
			...
			<div class="star-rating">
				...
				<?php endif; ?>
				<span>(
					<?php echo $number_of_ratings; ?> ratings)
				</span>
			</div>
