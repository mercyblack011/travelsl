...
<head>
	<title>Thai Manor Beach-Travelsl</title>
	<meta charset="utf-8">
...
<div class="preloader">
    ...
    contentElements.forEach(function(element) {
		...
		<div class="home">
			...
			$sql = "SELECT image_url FROM  place WHERE name = 'Thai Manor Beach'"; // Change the WHERE condition as needed
			...
			<div class="home_content">
				<div class="home_title">Thai Manor Beach
</div>
			</div>
		</div>
...
<section class="content-1">
    ...
    <article class="art"> 
        <p>TThai Manor Beach, an oasis of tranquility, is known for its shallow waters and the unique casuarina tree groves that offer a serene ambiance. The beach is a popular local retreat, ideal for families and those seeking a peaceful communion with nature away from the hustle of city life. It’s a perfect spot for a refreshing swim or a leisurely walk along the sandy shores, especially during the golden hours of sunrise and sunset.</p>
    ...
    <script>
            function initMap() {
                var map = new google.maps.Map(document.getElementById('map'), {
                    ...
                    center: {lat: 9.841913, lng: 80.25805}, // Center map on given coordinates
            ...
            var marker = new google.maps.Marker({
                position: {lat: 9.841913, lng: 80.25805},
                map: map,
