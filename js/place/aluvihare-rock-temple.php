...
<head>
	<title>Aluvihare Rock Temple-Travelsl</title>
	<meta charset="utf-8">
...
<div class="preloader">
    ...
    contentElements.forEach(function(element) {
		...
		<div class="home">
			...
			$sql = "SELECT image_url FROM  place WHERE name = 'Aluvihare Rock Temple'"; // Change the WHERE condition as needed
			...
			<div class="home_content">
				<div class="home_title">Aluvihare Rock Temple</div>
			</div>
		</div>
...
<p>Today, the Aluvihare Rock Temple remains a place of reverence and pilgrimage for Buddhists, attracting visitors who come to pay homage to its rich heritage and spiritual legacy. The temple complex comprises several rock-cut caves adorned with ancient frescoes depicting scenes from Buddhist lore and history.</p>

<p>The serene ambiance of the temple, nestled amidst verdant hills and shaded by towering trees, invites contemplation and reflection. Visitors can explore the caves, marvel at the ancient inscriptions, and experience the timeless tranquility that pervades this sacred site.</p>
</article>
	...
	<div>
	 ...
	 <p class="map"> 
	 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.7055410663265!2d80.61920360971145!3d7.4977255924834125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3afcf5459de99697%3A0x61d8f01aa0e120b1!2sAluviharaya%20Rock%20Cave%20Temple!5e0!3m2!1sen!2slk!4v1714395994693!5m2!1sen!2slk" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	 </p>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($isValid) {
        ...
        if ($stmt->execute()) {
            ...
            echo '<script>window.location.href = "aluvihare-rock-temple.php";</script>';
...
<form id="feedback" action="aluvihare-rock-temple.php" method="post">
    <br>
    <br>
