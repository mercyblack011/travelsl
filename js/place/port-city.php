...
<head>
	<title>Port City-Travelsl</title>
	<meta charset="utf-8">
...
<div class="preloader">
    ...
    contentElements.forEach(function(element) {
		...
		<div class="home">
			...
			$sql = "SELECT image_url FROM  place WHERE name = 'Port City'"; // Change the WHERE condition as needed
			...
			<div class="home_content">
				<div class="home_title">Port City
</div>
			</div>
		</div>
...
<section class="content-1">
    ...
    <article class="art"> 
	<p>Located along the bustling waterfront of Colombo, the Port City is a futuristic mega-development project that promises to transform the landscape of Sri Lanka's capital and create a dynamic new hub for business, leisure, and culture. Spanning over 269 hectares of reclaimed land, this iconic development is set to become one of the largest and most ambitious urban projects in South Asia, making it a must-visit destination for travelers seeking to witness the future of Sri Lanka's skyline.</p>
<p>As you explore the Port City, you'll be struck by its sleek skyscrapers, futuristic architecture, and state-of-the-art amenities, which are designed to rival the world's most iconic urban centers. The development will feature a mix of residential, commercial, and recreational spaces, as well as parks, promenades, and cultural venues, creating a vibrant and dynamic environment that's unlike anything else in the region.</p>
<p>But it's not just about the architecture and infrastructure at the Port City; it's also about the economic and social opportunities that it promises to bring to Sri Lanka and its people. The development is expected to generate thousands of jobs, attract billions of dollars in investment, and stimulate economic growth and development across the country, while also providing a new home for residents and businesses seeking a modern and sustainable urban lifestyle.</p>
<p>For visitors, a tour of the Port City offers the chance to witness the birth of a new era in Sri Lanka's history and development. Whether you're marveling at the skyline from a rooftop terrace, exploring the parks and public spaces, or simply soaking up the atmosphere amidst the bustling streets, there's something for everyone to enjoy at this iconic urban destination.</p>
<p>So whether you're a business traveler, a leisure seeker, or simply someone with a sense of curiosity, the Port City beckons with open arms, inviting you to witness the future of Sri Lanka's skyline and be a part of its ongoing transformation.</p>        
    </article>
	...
	<div>
	 ...
	 <p class="map"> 
	 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15842.609354852071!2d79.82229867610567!3d6.932091488620578!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2592cf4eff9d9%3A0xb4db8c89d7d055b0!2sPort%20City%20Colombo!5e0!3m2!1sen!2slk!4v1714465301338!5m2!1sen!2slk" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	 </p>
